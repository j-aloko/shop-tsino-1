...
export async function getCart({ cartId, language = defaultLanguage }) {
...
// Storefront query handler
export async function createCart({ buyerIdentity, language = defaultLanguage }) {
  const res = await shopifyStorefrontApi({
    cache: 'no-store',
    query: createCartMutation,
    variables: { buyerIdentity, language },
  });
...
// Storefront query handler
export async function addToCart({ cartId, lines, language = defaultLanguage }) {
  const res = await shopifyStorefrontApi({
    cache: 'no-store',
...
// Storefront query handler
export async function removeFromCart({ cartId, lineIds, language = defaultLanguage }) {
  const res = await shopifyStorefrontApi({
    cache: 'no-store',
...
// Storefront query handler
export async function updateCart({ cartId, lines, language = defaultLanguage }) {
  const res = await shopifyStorefrontApi({
    cache: 'no-store',
...
// Storefront query handler
export async function updateCartBuyerIdentity({ buyerIdentity, cartId, language = defaultLanguage }) {
  const res = await shopifyStorefrontApi({
    cache: 'no-store',
